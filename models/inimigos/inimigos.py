...
class Goblin(Inimigo):
    ...
    def __init__(self,nome,nome_ataque):
        ...
        super.__init__(nome = "Goblin", vida = 100, ataque = 7, defesa = 7, nome_ataque = "Furia Goblin" )
    ...
    def habilidade_especial(self,alvo):
        ...
        if  self.defesa == 7:
            ...
            self.defesa -= 2
            self.ataque += 2
            print("{self.nome} usou {self.nome_ataque}, ao usar seu poder seu ataque ficou pra {self.ataque} e sua defesa {self.defesa} .")
...
class Ladrao(Inimigo):
        ...
        def __init__(self,nome,nome_ataque):
            ...
            super.__init__(nome = "Ladrão", vida = 100, ataque = 11, defesa = 3 ,nome_ataque = "Disparo de adaga" )
...
class Golen(Inimigo):
        ...
        def __init__(self, nome , nome_ataque):
            super.__init__(nome = "Golen" ,vida = 100, ataque = 20, defesa =15, nome_ataque = "Soco de pedra")
...
class Demonio(Inimigo):
        def  __init__(self, nome, nome_ataque):
            ...
            super.__init__(nome = "Trigon", vida = 100, ataque = 50, defesa = 50, nome_ataque = "Passeio no inferno")
